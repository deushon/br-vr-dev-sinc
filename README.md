...
- Управление руками робота через сервоприводы
...
**Правая рука:**
- ID14: 126 - Правое плечо, вперед-назад
- ID16: 167 - Правое плечо вверх-вниз  
- ID18: 498 - Правое предплечье поворот
- ID20: 956 - Правое предплечье сгибание локтя
- ID22: 500 - Правый захват руки (сжимает/разжимает руку)

**Левая рука:**
- ID13: 874 - Левое плечо вперед-назад
- ID15: 833 - Левое плечо вверх-вниз
- ID17: 502 - Левое предплечье поворот  
- ID19: 44 - Левое предплечье сгибание локтя
- ID21: 500 - Левый захват руки (сжимает/разжимает руку)
...
Код готов для добавления полного управления руками робота через VR контроллеры. Методы `process_arms_control()` и соответствующие публикаторы можно легко расширить для управления в реальном времени.
